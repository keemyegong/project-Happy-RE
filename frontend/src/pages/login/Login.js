...
import kakaoimg from '../../assets/images/7595660_kakao_message_social_logo_icon.png';
import googleimg from '../../assets/images/imgbin_google-logo-business-png.png';
import './Login.css';
    ...
    <div className='Login'>
      <div className='login-container'>
        <div className='login-title-container'> 
          ...
          <img src={googleimg} alt="Google" style={{ width: '100px', height: '100px' }} />

          <img src={kakaoimg} alt="Kakao" style={{ width: '100px', height: '100px' }} />
