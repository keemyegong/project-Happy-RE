    ...
    <div className='Login'>
      <div className='login-container'>
        <div className='login-title-container'> 
          ...
          <img src={googleimg} onClick={googleLogin}alt="Google" style={{ width: '100px', height: '100px' }} />
          <img src={kakaoimg} onClick={kakaoLogin} alt="Kakao" style={{ width: '100px', height: '100px' }} />
