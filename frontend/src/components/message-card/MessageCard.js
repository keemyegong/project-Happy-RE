      ...
      <div className="message-card-header">
        ...
        <div className="user-info">
          ...
          <button className={`favorite-button ${archived || favorite ? 'favorite' : ''}`} onClick={handleFavoriteClick}>
            {/* <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" className={`bi bi-star-fill click-star ${archived || favorite ? 'filled' : ''}`} viewBox="0 0 16 16">
